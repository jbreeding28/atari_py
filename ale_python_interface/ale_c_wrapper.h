...
extern "C" {
  ...
  void act(ALEInterface *ale,int player_a_action,int player_b_action, int *reward_1, int *reward_2){return ale->act((Action)player_a_action,(Action)player_b_action,reward_1,reward_2);}
